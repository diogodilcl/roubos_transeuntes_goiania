...
class CityQuantity(db.Model, Base):
    ...
    city_id = db.Column('city_id', db.Integer, db.ForeignKey("tcc.city.id"))
...
class NeighborhoodQuantity(db.Model, Base):
    ...
    theft = db.Column('theft', db.Integer)
    date_occurrence = db.Column('date_occurrence', db.DateTime)
    neighborhood_id = db.Column('neighborhood_id', db.Integer, db.ForeignKey("tcc.neighborhood.id"))
    created_at = db.Column('created_at', db.DateTime, default=datetime.utcnow())
...
class DistrictQuantity(db.Model, Base):
    ...
    theft = db.Column('theft', db.Integer)
    date_occurrence = db.Column('date_occurrence', db.DateTime)
    district_id = db.Column('district_id', db.Integer, db.ForeignKey("tcc.district.id"))
    created_at = db.Column('created_at', db.DateTime, default=datetime.utcnow())
